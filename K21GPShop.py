...
appliances_list=[]
name=Label(Heading,text="K21GP Shop",font="arial 20 bold italic",bg="light pink",fg="blue").grid(row=0,column=1)
...
Coupon_1=Label(Coupon_frame,text="Get 5% Off on your purchase(upto Rs.500)",font="times 12",fg="yellow",bg="brown")
Coupon_2=Label(Coupon_frame,text="Get 10% Off on your purchase(upto Rs.750)",font="times 12",fg="yellow",bg="brown")
Coupon_3=Label(Coupon_frame,text="Get 15% Off on your purchase(upto Rs.1000)",font="times 12",fg="yellow",bg="brown")
...
def Bill():
    ...
    if op:
        ...
        if 0.1*total_price<750:
            ...
            discount[1]=750
        if 0.15*total_price<1000:
            discount[2]=0.05*total_price
        else:
            discount[2]=1000
        max_discount=max(discount)
        if max_discount==discount[0]:
            suggest=Label(root,bd=1,text="Suggested : 5% Off upto Rs.500",font="times 12",fg="blue").place(x=545,y=480)
            ...
            suggest=Label(root,bd=1,text="Suggested : 15% Off upto Rs.1000",font="times 12",fg="blue").place(x=545,y=480)
        def GenBill(d,choice):
            ...
            bill_txt_area.insert(END,Spaces(40)+"K21GP Shop\n"+Spaces(90,'*')+"\n")
            ...
            if choice==1:
                bill_txt_area.insert(END,"\nCoupon Applied : 5% Off upto Rs.500")
            elif choice==2:
                bill_txt_area.insert(END,"\nCoupon Applied : 10% Off upto Rs.750")
            else:
                bill_txt_area.insert(END,"\nCoupon Applied : 15% Off upto Rs.1000")
        ...
        Coupon_apply1=Button(Coupon_frame_2,text="5% Off upto Rs.500",font="times 20 bold",width=17,bd=6,bg="cadetblue",fg="white",activebackground="light blue",command=lambda:GenBill(discount[0],1))
        ...
        Coupon_apply3=Button(Coupon_frame_2,text="15% Off upto Rs.1000",font="times 20 bold",width=17,bd=6,bg="cadetblue",fg="white",activebackground="light blue",command=lambda:GenBill(discount[2],3))
